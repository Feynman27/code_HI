...
///////////////////////////////////////////////////////////////////////////////
//Function for plotting efficiencies as a fcn of pT 
///////////////////////////////////////////////////////////////////////////////
void calcEffPt(RooDataSet* mcWGenSet, RooDataSet* mcWFidSet,RooDataSet* mcWRecSet0, RooDataSet* mcWRecSet1,
    ...
    ///rec eff
    double xPt = ptLow + (ptUpp-ptLow)/2.0;
    ...
    ///get trig eff for this centraliy/eta bin 
    ///(not binned in pt)
    ...
    grWRecEff0->SetPoint(ipt,xPt,recoEff0);
    grWRecEff0->SetPointError(ipt,0.0,recoStatErr0);
    ...
    grWRecEff1->SetPoint(ipt,xPt,recoEff1);
    grWRecEff1->SetPointError(ipt,0.0,recoStatErr1);
    ...
    grWRecEff2->SetPoint(ipt,xPt,recoEff2);
    grWRecEff2->SetPointError(ipt,0.0,recoStatErr2);
    ...
    grWRecEff3->SetPoint(ipt,xPt,recoEff3);
    grWRecEff3->SetPointError(ipt,0.0,recoStatErr3);
    ...
    grWRecEff4->SetPoint(ipt,xPt,recoEff4);
    grWRecEff4->SetPointError(ipt,0.0,recoStatErr4);
    ...
    grWRecEff5->SetPoint(ipt,xPt,recoEff5);
    grWRecEff5->SetPointError(ipt,0.0,recoStatErr5);
...
///////////////////////////////////////////////////////////////////////////////
//Function for plotting efficiencies as a fcn of eta 
///////////////////////////////////////////////////////////////////////////////
...
///pt distributions
TGraphErrors* const grWRecEff0Pt = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff0PtPlus = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff0PtMinus = new TGraphErrors(nPtBins);

TGraphErrors* const grWRecEff1Pt = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff1PtPlus = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff1PtMinus = new TGraphErrors(nPtBins);

TGraphErrors* const grWRecEff2Pt = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff2PtPlus = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff2PtMinus = new TGraphErrors(nPtBins);

TGraphErrors* const grWRecEff3Pt = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff3PtPlus = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff3PtMinus = new TGraphErrors(nPtBins);

TGraphErrors* const grWRecEff4Pt = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff4PtPlus = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff4PtMinus = new TGraphErrors(nPtBins);

TGraphErrors* const grWRecEff5Pt = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff5PtPlus = new TGraphErrors(nPtBins);
TGraphErrors* const grWRecEff5PtMinus = new TGraphErrors(nPtBins);
...
///reconstructed sub-sets
  ...
  TObjArray* arrSubSetWRecNoQualityWselNoIsoNoZveto[nPtBins][nEtaBins][nCentralityBins];
  TObjArray* arrSubSetWRecNoQualityWselNoIso[nPtBins][nEtaBins][nCentralityBins];
  TObjArray* arrSubSetWRecNoQualityWsel[nPtBins][nEtaBins][nCentralityBins];
  TObjArray* arrSubSetWRecHiQualityWselNoIsoNoZveto[nPtBins][nEtaBins][nCentralityBins];
  TObjArray* arrSubSetWRecHiQualityWselNoIso[nPtBins][nEtaBins][nCentralityBins];
  TObjArray* arrSubSetWRecHiQualityWsel[nPtBins][nEtaBins][nCentralityBins];
...
//            etaBins[j+1],centBins[k], centBins[k+1],true,false); 
	  ...
	  for(int icent=0; icent<nCentralityBins; icent++){
          ...
          for(int ieta=0; ieta<nEtaBins; ieta++){
                ...
                for(int ipt=0; ipt<nPtBins; ipt++){
                   ...
                   double ptLow = ptBins.at(ipt);
                   double etaUpp = ptBins.at(ipt+1); 
              
	               int index = ieta*nCentralityBins+icent; 
                
			        std::cout << "mu^{#pm}" << std::endl;
              
                    calcEffPt(mcWGenSubSet[ipt][ieta][icent],mcWFidSubSet[ipt][ieta][icent],
                        ...
                        104,ipt,ieta, icent, index, nCentralityBins,nEtaBins,ptLow, ptUpp,
                        grWRecEff0Pt,grWRecEff1Pt,grWRecEff2Pt,grWRecEff3Pt,grWRecEff4Pt,grWRecEff5Pt);
              ...
              if(doCharge){
                ...
                calcEffEta(mcWGenSetPlus,mcWFidSetPlus,
                    ...
                    102,ipt,ieta, icent, index, nCentralityBins, nEtaBins,ptLow, ptUpp,
      ...
      for(int ipt=0; ipt<nPtBins; ipt++){
		  for(int icent=0; icent<nCentralityBins; icent++){
            ...
            TString sEffName0 = "grWmunuRecNoQualityWselNoIsoNoZvetoEtaDistroCent"; sEffName0+=icent; sEffName0+="Pt"; sEffName0+=ipt;
            TString sEffNamePlus0 = "grWmunuRecNoQualityWselNoIsoNoZvetoEtaDistroPlusCent"; sEffNamePlus0+=icent; sEffNamePlus0+="Pt"; sEffNamePlus0+=ipt;
            TString sEffNameMinus0 = "grWmunuRecNoQualityWselNoIsoNoZvetoEtaDistroMinusCent"; sEffNameMinus0+=icent; sEffNameMinus0+="Pt"; sEffNameMinus0+=ipt;

            TString sEffName1 = "grWmunuRecNoQualityWselNoIsoEtaDistroCent"; sEffName1+=icent;sEffName1+="Pt"; sEffName1+=ipt;
            TString sEffNamePlus1 = "grWmunuRecNoQualityWselNoIsoEtaDistroPlusCent"; sEffNamePlus1+=icent;sEffNamePlus0+="Pt"; sEffNamePlus0+=ipt;
            TString sEffNameMinus1 = "grWmunuRecNoQualityWselNoIsoEtaDistroMinusCent"; sEffNameMinus1+=icent;sEffNameMinus0+="Pt"; sEffNameMinus0+=ipt;

            TString sEffName2 = "grWmunuRecNoQualityWselEtaDistroCent"; sEffName2+=icent;sEffName2+="Pt"; sEffName2+=ipt;
            TString sEffNamePlus2 = "grWmunuRecNoQualityWselEtaDistroPlusCent"; sEffNamePlus2+=icent;sEffNamePlus0+="Pt"; sEffNamePlus0+=ipt;
            TString sEffNameMinus2 = "grWmunuRecNoQualityWselEtaDistroMinusCent"; sEffNameMinus2+=icent;sEffNameMinus0+="Pt"; sEffNameMinus0+=ipt;

            TString sEffName3 = "grWmunuRecHiQualityWselNoIsoNoZvetoEtaDistroCent"; sEffName3+=icent;sEffName3+="Pt"; sEffName3+=ipt;
            TString sEffNamePlus3 = "grWmunuRecHiQualityWselNoIsoNoZvetoEtaDistroPlusCent"; sEffNamePlus3+=icent;sEffNamePlus0+="Pt"; sEffNamePlus0+=ipt;
            TString sEffNameMinus3 = "grWmunuRecHiQualityWselNoIsoNoZvetoEtaDistroMinusCent"; sEffNameMinus3+=icent;sEffNameMinus0+="Pt"; sEffNameMinus0+=ipt;

            TString sEffName4 = "grWmunuRecHiQualityWselNoIsoEtaDistroCent"; sEffName4+=icent;sEffName0+="Pt"; sEffName0+=ipt;
            TString sEffNamePlus4 = "grWmunuRecHiQualityWselNoIsoEtaDistroPlusCent"; sEffNamePlus4+=icent;sEffNamePlus0+="Pt"; sEffNamePlus0+=ipt;
            TString sEffNameMinus4 = "grWmunuRecHiQualityWselNoIsoEtaDistroMinusCent"; sEffNameMinus4+=icent;sEffNameMinus0+="Pt"; sEffNameMinus0+=ipt;

            TString sEffName5 = "grWmunuRecHiQualityWselEtaDistroCent"; sEffName5+=icent;sEffName0+="Pt"; sEffName0+=ipt;
            TString sEffNamePlus5 = "grWmunuRecHiQualityWselEtaDistroPlusCent"; sEffNamePlus5+=icent;sEffNamePlus0+="Pt"; sEffNamePlus0+=ipt;
            TString sEffNameMinus5 = "grWmunuRecHiQualityWselEtaDistroMinusCent"; sEffNameMinus5+=icent;sEffNameMinus0+="Pt"; sEffNameMinus0+=ipt;
...
*/
    ...
    for(int iset = 0; iset<vecSetNames.size() ; ++iset){

	  for(int ipt=0; ipt<nPtBins; ipt++){

            double ptbinLo = ptBins.at(ipt);
            double ptbinUp = ptBins.at(ipt+1); 
            double xPt = ptbinLo+(ptbinUp-ptbinLo)/2.0; 
		...
		for(int ieta=0; ieta<nEtaBins; ieta++){
		  ...
		  for(int icent=0; icent<nCentralityBins; icent++){
            ...
            ///index for trigger based on only
            ///eta and centrality(i.e. no pt dependence)
			int index = ieta*nCentralityBins+icent; 
			double npart = npartBins.at(icent); 
			
            ///naming convention of Cw pt,eta,and centrality distributions
            TString sEffPtName = vecPtSetNames.at(iset); sEffPtName+="_Pt"; sEffPtName+=ipt; sEffPtName+="_Eta";
                sEffPtName+=ieta; sEffPtName+="_Cent"; sEffPtName+=icent;
            ...
            ///end point; pickup after lunch
            std::vector<TString> vecPtSetNames,vecEtaSetNames,vecCentSetNames; 
            vecPtSetNames.push_back("grPtWmunuRecNoQualityWselNoIsoNoZveto");

            vecEtaSetNames.push_back("grEtaWmunuRecNoQualityWselNoIsoNoZveto");

            vecCentSetNames.push_back("grCentWmunuRecNoQualityWselNoIsoNoZveto");

            TString sEffEtaName1 = "grEtaWmunuRecNoQualityWselNoIso_Pt"; sEffEtaName1+=ipt; sEffEtaName1+="_Eta"; sEffEtaName1+=ieta; sEffEtaName1+="_Cent"; 
                sEffEtaName1+=icent; 

            TString sEffEtaName2 = "grEtaWmunuRecNoQualityWsel_Pt"; sEffEtaName2+=ipt; sEffEtaName2+="_Eta"; sEffEtaName2+=ieta;sEffEtaName2+="_Cent"; sEffEtaName2+=icent;

            TString sEffEtaName3 = "grEtaWmunuRecHiQualityWselNoIsoNoZveto_Pt"; sEffEtaName3+=ipt; sEffEtaName3+="_Eta"; sEffEtaName3+=ieta; sEffEtaName3+="_Cent"; 
                sEffEtaName3+=icent;

            TString sEffEtaName4 = "grEtaWmunuRecHiQualityWselNoIso_Pt"; sEffEtaName4+=ipt; sEffEtaName4+="_Eta"; sEffEtaName4+=ieta; sEffEtaName4+="_Cent"; 
                sEffEtaName4+=icent;

            TString sEffEtaName5 = "grEtaWmunuRecHiQualityWsel_Pt"; sEffEtaName5+=ipt; sEffEtaName5+="_Eta"; sEffEtaName5+=ieta; sEffEtaName5+="_Cent"; sEffEtaName5+=icent;
