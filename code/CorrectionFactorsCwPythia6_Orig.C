...
///////////////////////////////////////////////////////////////////////////////
void plotChargeDiffCwNpart(TGraph* const grDiff, TGraphErrors* const grPlus, TGraphErrors* const grMinus, int ieta, int icent, double npart){
...
///////////////////////////////////////////////////////////////////////////////
void plotChargeDiffCwEta(TGraph* const grDiff, TGraphErrors* const grPlus, TGraphErrors* const grMinus, int ieta, int icent, double xEta) {
...
///////////////////////////////////////////////////////////////////////////////
void plotChargeDiffAx(TGraph* const grDiff, TGraphErrors* const grPlus, TGraphErrors* const grMinus, int ieta, double xEta){
...
void calcEfficiency(RooDataSet* mcWGenSet, RooDataSet* mcWFidSet,RooDataSet* mcWRecSet0, RooDataSet* mcWRecSet1,
                ...
                TGraphAsymmErrors* grAw, TGraphAsymmErrors* grCwAw,                 
		        TGraphAsymmErrors* grWRecEff0, TGraphAsymmErrors* grWRecEff1,TGraphAsymmErrors* grWRecEff2,
                TGraphAsymmErrors* grWRecEff3,TGraphAsymmErrors* grWRecEff4,TGraphAsymmErrors* grWRecEff5, 
...
//    std::cout << "pRecOnly = " << pRecOnly << std::endl;
    ...
    Efficiency(pRec5,tGen,0.683,CwAw,errCwAwLo,errCwAwHi);
...
void fit(TGraphAsymmErrors* gr, TGraphErrors* grA0, TGraphErrors* grA1, TGraphErrors* grA2, int ich, int ieta, double xEta, bool fixA2, bool fixA1){
...
TGraphAsymmErrors* grCwNpartPlus = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grCwNpartMinus = new TGraphAsymmErrors(nCentralityBins);
TGraph* grCwNpartDiff = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grCwNpart = new TGraphAsymmErrors(nCentralityBins);


TGraphAsymmErrors* grAwCent = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grAwCentPlus = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grAwCentMinus = new TGraphAsymmErrors(nCentralityBins);

TGraphAsymmErrors* grCwAwCent = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grCwAwCentPlus = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grCwAwCentMinus = new TGraphAsymmErrors(nCentralityBins);

TGraphAsymmErrors* grWRecEff0Cent = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff0CentPlus = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff0CentMinus = new TGraphAsymmErrors(nCentralityBins);

TGraphAsymmErrors* grWRecEff1Cent = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff1CentPlus = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff1CentMinus = new TGraphAsymmErrors(nCentralityBins);

TGraphAsymmErrors* grWRecEff2Cent = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff2CentPlus = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff2CentMinus = new TGraphAsymmErrors(nCentralityBins);

TGraphAsymmErrors* grWRecEff3Cent = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff3CentPlus = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff3CentMinus = new TGraphAsymmErrors(nCentralityBins);

TGraphAsymmErrors* grWRecEff4Cent = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff4CentPlus = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff4CentMinus = new TGraphAsymmErrors(nCentralityBins);

TGraphAsymmErrors* grWRecEff5Cent = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff5CentPlus = new TGraphAsymmErrors(nCentralityBins);
TGraphAsymmErrors* grWRecEff5CentMinus = new TGraphAsymmErrors(nCentralityBins);

///eta dep plots
TGraphAsymmErrors* grCwEtaPlus = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grCwEtaMinus = new TGraphAsymmErrors(nEtaBins);
TGraph* const grCwEtaDiff = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grCwEta = new TGraphAsymmErrors(nEtaBins);

TGraphAsymmErrors* grAwEta = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grAwEtaPlus = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grAwEtaMinus = new TGraphAsymmErrors(nEtaBins);

TGraphAsymmErrors* grCwAwEta = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grCwAwEtaPlus = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grCwAwEtaMinus = new TGraphAsymmErrors(nEtaBins);

TGraphAsymmErrors* grWRecEff0Eta = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff0EtaPlus = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff0EtaMinus = new TGraphAsymmErrors(nEtaBins);

TGraphAsymmErrors* grWRecEff1Eta = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff1EtaPlus = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff1EtaMinus = new TGraphAsymmErrors(nEtaBins);

TGraphAsymmErrors* grWRecEff2Eta = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff2EtaPlus = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff2EtaMinus = new TGraphAsymmErrors(nEtaBins);

TGraphAsymmErrors* grWRecEff3Eta = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff3EtaPlus = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff3EtaMinus = new TGraphAsymmErrors(nEtaBins);

TGraphAsymmErrors* grWRecEff4Eta = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff4EtaPlus = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff4EtaMinus = new TGraphAsymmErrors(nEtaBins);

TGraphAsymmErrors* grWRecEff5Eta = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff5EtaPlus = new TGraphAsymmErrors(nEtaBins);
TGraphAsymmErrors* grWRecEff5EtaMinus = new TGraphAsymmErrors(nEtaBins);

///Pt

TGraphAsymmErrors* grAwPt = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grAwPtPlus = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grAwPtMinus = new TGraphAsymmErrors(nPtBins);

TGraphAsymmErrors* grCwAwPt = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grCwAwPtPlus = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grCwAwPtMinus = new TGraphAsymmErrors(nPtBins);

TGraphAsymmErrors* grWRecEff0Pt = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff0PtPlus = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff0PtMinus = new TGraphAsymmErrors(nPtBins);

TGraphAsymmErrors* grWRecEff1Pt = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff1PtPlus = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff1PtMinus = new TGraphAsymmErrors(nPtBins);

TGraphAsymmErrors* grWRecEff2Pt = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff2PtPlus = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff2PtMinus = new TGraphAsymmErrors(nPtBins);

TGraphAsymmErrors* grWRecEff3Pt = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff3PtPlus = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff3PtMinus = new TGraphAsymmErrors(nPtBins);

TGraphAsymmErrors* grWRecEff4Pt = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff4PtPlus = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff4PtMinus = new TGraphAsymmErrors(nPtBins);

TGraphAsymmErrors* grWRecEff5Pt = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff5PtPlus = new TGraphAsymmErrors(nPtBins);
TGraphAsymmErrors* grWRecEff5PtMinus = new TGraphAsymmErrors(nPtBins);
...
*/
  ...
  //RooDataSet* mcWGenSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn+".root",muonGenArgSet); mcWGenSet->Print();
  RooDataSet* mcWGenSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn+".root",muonGenArgSet); mcWGenSet->Print();
  ...
  */
  /*RooDataSet* mcWGeomFidSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn+".root",muonGenArgSet); 
...
*/
  ...
  RooDataSet* mcWFidSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn+".root",muonGenArgSet); 
...
//  mcWFidSetMinus = (RooDataSet*)mcWFidSetMinus->reduce("daughterNu==-14");
  ...
  double fidInclusive = mcWFidSet->numEntries(); double genInclusive = mcWGenSet->numEntries();
  double awInclusive, errAwInclusiveLo, errAwInclusiveHi;
  double awPlus,errAwPlusLo,errAwPlusHi;
  Efficiency(fidInclusive,genInclusive,0.683,awInclusive,errAwInclusiveLo,errAwInclusiveHi);
  ...
  std::cout << " Inclusive Aw = " << mcWFidSet->numEntries() << "/" << mcWGenSet->numEntries() << " = " << fidInclusive/genInclusive << std::endl;
...
/*  RooDataSet* mcWRecLooseSet = fillHIMuonRecSet("/usatlas/u/tbales/scratch/",fileNameIn+".root",muonRecArgSet); 
...
/*  RooDataSet* mcWRecSet = fillHIMuonRecSet("/usatlas/u/tbales/scratch/",fileNameIn+".root",muonRecArgSet); 
...
*/
  ...
  RooDataSet* mcSetWRecNoQualityWselNoIsoNoZveto =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/",fileNameIn+".root",muonRecArgSet); 
  ...
  RooDataSet* mcSetWRecHiQualityWsel =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/",fileNameIn+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
	...
	_cWResiduals.Add( new TGraph(nCentralityBins) );
      ...
      for ( int k = 0; k < nCentralityBins; k++ ){
        ...
        if(doEta)
            ...
            mcWGenSubSet[i][j][k] = selectCentrality(mcWGenSet,centBins[k], centBins[k+1]); 
        ...
        mcSubSetWRecNoQualityWselNoIsoNoZveto[i][j][k] = selectPtEtaCentrality(mcSetWRecNoQualityWselNoIsoNoZveto,ptBins[i],ptBins[i+1],
          ...
          if(doMptSigmaDown||doMptSigmaUp) {
                ...
                //mcSubSetWRecHiQualityWsel[i][j][k] = selectMptMt(mcSubSetWRecHiQualityWsel[i][j][k],mptLow[k],_pfxMptMtCorrelation); 
          }
  ...
  if(doEta){
   ...
   for(int ipt=0; ipt<nPtBins; ipt++){
	...
	for(int icent=0; icent<nCentralityBins; icent++){
            ...
            TString sEffNameAw = "grAwEtaDistroCent"; sEffNameAw+=icent;
            TString sEffNameAwPlus = "grAwPlusEtaDistroCent"; sEffNameAwPlus+=icent;
            TString sEffNameAwMinus = "grAwMinusEtaDistroCent"; sEffNameAwMinus+=icent;
            TString sEffNameCwAw = "grCwAwEtaDistroCent"; sEffNameCwAw+=icent;
            TString sEffNameCwAwPlus = "grCwAwPlusEtaDistroCent"; sEffNameCwAwPlus+=icent;
            TString sEffNameCwAwMinus = "grCwAwMinusEtaDistroCent"; sEffNameCwAwMinus+=icent;
            ...
            for(int ieta=0; ieta<nEtaBins; ieta++){
              ...
              calcEfficiency(mcWGenSubSet[ipt][ieta][icent],mcWFidSubSet[ipt][ieta][icent],
                    ...
                    ieta, etaMed, binW, index,ipt,ieta,icent,grAwEta,grCwAwEta,
                    grWRecEff0Eta,grWRecEff1Eta,grWRecEff2Eta,grWRecEff3Eta,grWRecEff4Eta,grWRecEff5Eta,spreadSheet);

              if(doCharge){

                mcWGenSetPlus  = (RooDataSet*) mcWGenSubSet[ipt][ieta][icent]->reduce(Cut("chargeGenCategory==chargeGenCategory::muPlus"));
                mcWGenSetMinus  = (RooDataSet*) mcWGenSubSet[ipt][ieta][icent]->reduce(Cut("chargeGenCategory==chargeGenCategory::muMinus"));

                mcWFidSetPlus  = (RooDataSet*) mcWFidSubSet[ipt][ieta][icent]->reduce(Cut("chargeGenCategory==chargeGenCategory::muPlus"));
                mcWFidSetMinus  = (RooDataSet*) mcWFidSubSet[ipt][ieta][icent]->reduce(Cut("chargeGenCategory==chargeGenCategory::muMinus"));
                ...
                calcEfficiency(mcWGenSetPlus,mcWFidSetPlus,
                    ...
                    ieta, etaMed, binW, index,ipt, ieta,icent,grAwEtaPlus,grCwAwEtaPlus,
                ...
                calcEfficiency(mcWGenSetMinus,mcWFidSetMinus,
                    ...
                    ieta, etaMed, binW, index,ipt,ieta,icent,grAwEtaMinus,grCwAwEtaMinus,
              ...
              Write(outFile,grAwEta,sEffNameAw);
              Write(outFile,grCwAwEta,sEffNameCwAw);
              ...
              if(doCharge){
                Write(outFile,grAwEtaPlus,sEffNameAwPlus);
                Write(outFile,grCwAwEtaPlus,sEffNameCwAwPlus);
                ...
                Write(outFile,grAwEtaMinus,sEffNameAwMinus);
                Write(outFile,grCwAwEtaMinus,sEffNameCwAwMinus);
...
*/
            ...
            TString sEffNameAw = "grAwNpartDistroEta"; sEffNameAw+=ieta;
            TString sEffNameAwPlus = "grAwNpartDistroPlusEta"; sEffNameAwPlus+=ieta;
            TString sEffNameAwMinus = "grAwNpartDistroMinusEta"; sEffNameAwMinus+=ieta;

            TString sEffNameCwAw = "grCwAwNpartDistroEta"; sEffNameCwAw+=ieta;
            TString sEffNameCwAwPlus = "grCwAwPlusNpartDistroEta"; sEffNameCwAwPlus+=ieta;
            TString sEffNameCwAwMinus = "grCwAwMinusNpartDistroEta"; sEffNameCwAwMinus+=ieta;
        ...
        calcEfficiency(mcWGenSubSet[ipt][ieta][icent],mcWFidSubSet[ipt][ieta][icent],
                    ...
                    mcSubSetWRecHiQualityWselNoIso[ipt][ieta][icent],
                    mcSubSetWRecHiQualityWsel[ipt][ieta][icent],
                    icent, npart, binW, index,ipt,ieta,icent,grAwCent,grCwAwCent,
	    ...
	    if(doCharge) {
			  ...
			  if(doPlotPt){
				...
				TH1F* hRecSubSetPlus = (TH1F*)mcSetWRecHiQualityWselPlusc->createHistogram("hRecSubSetPlus",muonPt,Binning(b)); 
				TH1F* hRecSubSetMinus = (TH1F*)mcSetWRecHiQualityWselMinusc->createHistogram("hRecSubSetMinus",muonPt,Binning(b)); 
		...
		std::cout << "mu^{+}" << std::endl;
                calcEfficiency(mcWGenSetPlus,mcWFidSetPlus,
                        ...
                        mcSetWRecHiQualityWselPlus,
                  	    icent, npart, binW, index,ipt,ieta,icent,grAwCentPlus,grCwAwCentPlus,
		...
		std::cout << "mu^{-}" << std::endl;
                calcEfficiency(mcWGenSetMinus,mcWFidSetMinus,
                        ...
                        mcSetWRecHiQualityWselMinus,
                  	    icent, npart, binW, index,ipt,ieta,icent,grAwCentMinus,grCwAwCentMinus,
	      ...
	      Write(outFile,grAwCent,sEffNameAw);
          Write(outFile,grCwAwCent,sEffNameCwAw);
          ...
          if(doCharge){
			Write(outFile,grAwCentPlus,sEffNameAwPlus);
			Write(outFile,grAwCentMinus,sEffNameAwMinus);
            Write(outFile,grCwAwCentPlus,sEffNameCwAwPlus);
            Write(outFile,grCwAwCentMinus,sEffNameCwAwMinus);
	  ...
	  for(int icent=0; icent<nCentralityBins; icent++){
            ...
            for(int ipt=0; ipt<nPtBins; ipt++){
              ...
              calcEfficiency(mcWGenSubSet[ipt][ieta][icent],mcWFidSubSet[ipt][ieta][icent],
                    ...
                    mcSubSetWRecHiQualityWselNoIso[ipt][ieta][icent],
                    mcSubSetWRecHiQualityWsel[ipt][ieta][icent],
                    ipt, ptMed, binW, index,ipt,ieta,icent,grAwPt,grCwAwPt,
              ...
              if(doCharge){
                ...
                calcEfficiency(mcWGenSetPlus,mcWFidSetPlus,
                    mcSetWRecNoQualityWselNoIsoNoZvetoPlus,mcSetWRecNoQualityWselNoIsoPlus,mcSetWRecNoQualityWselPlus,
                    mcSetWRecHiQualityWselNoIsoNoZvetoPlus, mcSetWRecHiQualityWselNoIsoPlus, mcSetWRecHiQualityWselPlus,
                    ipt, ptMed, binW, index,ipt, ieta,icent,grAwPtPlus,grCwAwPtPlus,
                ...
                calcEfficiency(mcWGenSetMinus,mcWFidSetMinus,
                    mcSetWRecNoQualityWselNoIsoNoZvetoMinus,mcSetWRecNoQualityWselNoIsoMinus,mcSetWRecNoQualityWselMinus,
                    mcSetWRecHiQualityWselNoIsoNoZvetoMinus, mcSetWRecHiQualityWselNoIsoMinus, mcSetWRecHiQualityWselMinus,
                    ipt, ptMed, binW, index,ipt,ieta,icent,grAwPtMinus,grCwAwPtMinus,
