...
void plot(TFile* fDataSet, TFile* fMcWSet, TFile* fMcZSet,TFile* fMcJ1Set,TFile* fMcJ2Set, TFile* fMcJ3Set, 
	...
	//initialize histograms
  	// --- data sets ---
	TH1F* hdataSet = new TH1F("hdataSet","hdataSet",nBins,-1*etaUpp,etaUpp);
  	// --- W set ---
	TH1F* hmcWSet = new TH1F("hmcWSet","hmcWSet",nBins,-1*etaUpp,etaUpp);
  	// --- Z set ---
	TH1F* hmcZSet = new TH1F("hmcZSet","hmcZSet",nBins,-1*etaUpp,etaUpp);
  	// --- QCD set ---
	TH1F* hmcJ1Set = new TH1F("hmcJ1Set","hmcJ1Set",nBins,-1*etaUpp,etaUpp);
	TH1F* hmcJ2Set = new TH1F("hmcJ2Set","hmcJ2Set",nBins,-1*etaUpp,etaUpp);
	TH1F* hmcJ3Set = new TH1F("hmcJ3Set","hmcJ3Set",nBins,-1*etaUpp,etaUpp);
	TH1F* hmcQCDSet = new TH1F("hmcQCDSet","hmcQCDSet",nBins,-1*etaUpp,etaUpp);
...
//	std::cout << "Region C cuts: " << scutsNonIsoMPTLo << std::endl;
	...
	tree->Draw("eta>>hdataSet",scutsSig,"pe");		
	...
	treeMcJ1Set->Draw("eta>>hmcJ1Set",cutsQCD,"hf");		
	treeMcJ2Set->Draw("eta>>hmcJ2Set",cutsQCD,"hf");		
	treeMcJ3Set->Draw("eta>>hmcJ3Set",cutsQCD,"hf");		
	...
	treeMcZSet->Draw("eta>>hmcZSet",cutsZ,"hf");		
	...
	treeMcWSet->Draw("eta>>hmcWSet",cutsW,"hf");		
	...
	leg->AddEntry(hmcZSetc, "Z#rightarrow#mu#mu", "f");
  	...
  	hdataSetc->GetXaxis()->SetTitle("#eta_{#mu}"); 
        float entriesPerBin = (etaUpp-etaLow)/nBins;
	...
	TString plotNameLog = "dataEta_"; plotNameLog+=sSel; plotNameLog+="_"; plotNameLog+=sSel2; plotNameLog+="_"; plotNameLog+="Log"; //.png";
	TString plotNameLin = "dataEta_"; plotNameLin+=sSel; plotNameLin+="_"; plotNameLin+=sSel2; plotNameLin+="_"; plotNameLin+="Lin"; //.png";
