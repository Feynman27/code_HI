...
//=========  (Sat Oct 19 18:30:39 2013) by ROOT version5.34/10
   TCanvas *cRcp = new TCanvas("cRcp", "cRcp",709,103,600,600);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: pad1
   ...
   grae->SetPointError(5,7.34243,7.34243,3.902567,3.902567);
   
   TH1F *Graph_graphWSumSyst_correlatedc5 = new TH1F("Graph_graphWSumSyst_correlatedc5","Graph",100,3.539247,424.1191);
   Graph_graphWSumSyst_correlatedc5->SetMinimum(22.26385);
   Graph_graphWSumSyst_correlatedc5->SetMaximum(33.92142);
   ...
   grae->SetPointError(5,7.34243,7.34243,2.039004,2.039004);
   
   TH1F *Graph_graphWPlusSumSyst_correlatedc6 = new TH1F("Graph_graphWPlusSumSyst_correlatedc6","Graph",100,3.539247,424.1191);
   Graph_graphWPlusSumSyst_correlatedc6->SetMinimum(11.46308);
   Graph_graphWPlusSumSyst_correlatedc6->SetMaximum(18.23138);
   ...
   grae->SetPointError(5,7.34243,7.34243,1.912439,1.912439);
   
   TH1F *Graph_graphWMinusSumSyst_correlatedc7 = new TH1F("Graph_graphWMinusSumSyst_correlatedc7","Graph",100,3.539247,424.1191);
   Graph_graphWMinusSumSyst_correlatedc7->SetMinimum(10.69483);
   Graph_graphWMinusSumSyst_correlatedc7->SetMaximum(16.26884);
   ...
   TLegendEntry *entry=leg->AddEntry("","W^{#pm}(Data)","pf");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(19.30338,33.77392,"ATLAS Internal");
   tex->SetTextFont(72);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   leg->SetFillColor(0);
   leg->SetFillStyle(1001);
   entry=leg->AddEntry("","W^{-}#rightarrow#mu^{-}(Data)","pf");
