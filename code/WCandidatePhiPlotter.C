...
void plot(TFile* fDataSet, TFile* fMcWSet, TFile* fMcZSet,TFile* fMcJ1Set,TFile* fMcJ2Set, TFile* fMcJ3Set, 
	...
	//initialize histograms
  	// --- data sets ---
	TH1F* hdataSet = new TH1F("hdataSet","hdataSet",nBins,-1*TMath::Pi(),TMath::Pi());
  	// --- W set ---
	TH1F* hmcWSet = new TH1F("hmcWSet","hmcWSet",nBins,-1*TMath::Pi(),TMath::Pi());
  	// --- Z set ---
	TH1F* hmcZSet = new TH1F("hmcZSet","hmcZSet",nBins,-1*TMath::Pi(),TMath::Pi());
  	// --- QCD set ---
	TH1F* hmcJ1Set = new TH1F("hmcJ1Set","hmcJ1Set",nBins,-1*TMath::Pi(),TMath::Pi());
	TH1F* hmcJ2Set = new TH1F("hmcJ2Set","hmcJ2Set",nBins,-1*TMath::Pi(),TMath::Pi());
	TH1F* hmcJ3Set = new TH1F("hmcJ3Set","hmcJ3Set",nBins,-1*TMath::Pi(),TMath::Pi());
	TH1F* hmcQCDSet = new TH1F("hmcQCDSet","hmcQCDSet",nBins,-1*TMath::Pi(),TMath::Pi());
...
//	std::cout << "Region C cuts: " << scutsNonIsoMPTLo << std::endl;
	...
	tree->Draw("phi>>hdataSet",scutsSig,"pe");		
	...
	treeMcJ1Set->Draw("phi>>hmcJ1Set",cutsQCD,"hf");		
	treeMcJ2Set->Draw("phi>>hmcJ2Set",cutsQCD,"hf");		
	treeMcJ3Set->Draw("phi>>hmcJ3Set",cutsQCD,"hf");		
	...
	treeMcZSet->Draw("phi>>hmcZSet",cutsZ,"hf");		
	...
	treeMcWSet->Draw("phi>>hmcWSet",cutsW,"hf");		
	...
	leg->AddEntry(hmcZSetc, "Z#rightarrow#mu#mu", "f");
  	...
  	hdataSetc->GetXaxis()->SetTitle("#phi_{#mu}"); 
        float entriesPerBin = (TMath::TwoPi())/nBins;
	...
	//hdataSetc->GetYaxis()->SetRangeUser(0.1,hmcWSetc->GetMaximum()+300.0); 
	...
	TString plotNameLog = "dataPhi_"; plotNameLog+=sSel; plotNameLog+="_"; plotNameLog+=sSel2; plotNameLog+="_"; plotNameLog+="Log"; //.png";
	TString plotNameLin = "dataPhi_"; plotNameLin+=sSel; plotNameLin+="_"; plotNameLin+=sSel2; plotNameLin+="_"; plotNameLin+="Lin"; //.png";
