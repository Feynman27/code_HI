...
void CorrectionFactorsCwPythia6(){
...
//PowPy8 samples
//pp
TString fileNameIn_pp = "MonteCarloFiles/Wmunu/HISingleMuonWmunuPYTHIADataOverlay_pp.07.19.2013";
//np
TString fileNameIn_np = "MonteCarloFiles/Wmunu/HISingleMuonWmunuPYTHIADataOverlay_np.07.19.2013";
//pn
TString fileNameIn_pn = "MonteCarloFiles/Wmunu/HISingleMuonWmunuPYTHIADataOverlay_pn.07.19.2013";
//nn
TString fileNameIn_nn = "MonteCarloFiles/Wmunu/HISingleMuonWmunuPYTHIADataOverlay_nn.07.19.2013";
...
//  TString sCutsRec = "muonQuality>11&&abs(muonELoss)<0.5&&abs(muonScat)<4.0&&abs(muonEta)<2.4&&muonPt>33.5&&missPt>25.0&&isolation<0.1&&muonMt>40.0&&ZDY==0";
  ...
  // pp
  RooDataSet* mcppWGenSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn_pp+".root",muonGenArgSet); mcppWGenSet->Print();
  // Separate into charge sets
  RooDataSet* mcppWGenSetPlus = (RooDataSet*)mcppWGenSet->reduce("chargeGen==+1.0");
  RooDataSet* mcppWGenSetMinus = (RooDataSet*)mcppWGenSet->reduce("chargeGen==-1.0");

  // np
  RooDataSet* mcnpWGenSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn_np+".root",muonGenArgSet); mcnpWGenSet->Print();
  // Separate into charge sets
  RooDataSet* mcnpWGenSetPlus = (RooDataSet*)mcnpWGenSet->reduce("chargeGen==+1.0");
  RooDataSet* mcnpWGenSetMinus = (RooDataSet*)mcnpWGenSet->reduce("chargeGen==-1.0");

  // pn
  RooDataSet* mcpnWGenSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn_pn+".root",muonGenArgSet); mcpnWGenSet->Print();
  // Separate into charge sets
  RooDataSet* mcpnWGenSetPlus = (RooDataSet*)mcpnWGenSet->reduce("chargeGen==+1.0");
  RooDataSet* mcpnWGenSetMinus = (RooDataSet*)mcpnWGenSet->reduce("chargeGen==-1.0");

  // nn
  RooDataSet* mcnnWGenSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn_nn+".root",muonGenArgSet); mcnnWGenSet->Print();
  // Separate into charge sets
  RooDataSet* mcnnWGenSetPlus = (RooDataSet*)mcnnWGenSet->reduce("chargeGen==+1.0");
  RooDataSet* mcnnWGenSetMinus = (RooDataSet*)mcnnWGenSet->reduce("chargeGen==-1.0");
  ...
  // pp
  RooDataSet* mcppWFidSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn_pp+".root",muonGenArgSet); 
  mcppWFidSet = (RooDataSet*)mcppWFidSet->reduce(Cut(cutsFid)); 
  RooDataSet* mcppWFidSetPlus = (RooDataSet*)mcppWFidSet->reduce("chargeGen==+1.0");
  RooDataSet* mcppWFidSetMinus = (RooDataSet*)mcppWFidSet->reduce("chargeGen==-1.0");

  // np
  RooDataSet* mcnpWFidSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn_np+".root",muonGenArgSet); 
  mcnpWFidSet = (RooDataSet*)mcnpWFidSet->reduce(Cut(cutsFid)); 
  RooDataSet* mcnpWFidSetPlus = (RooDataSet*)mcnpWFidSet->reduce("chargeGen==+1.0");
  RooDataSet* mcnpWFidSetMinus = (RooDataSet*)mcnpWFidSet->reduce("chargeGen==-1.0");

  // pn
  RooDataSet* mcpnWFidSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn_pn+".root",muonGenArgSet); 
  mcpnWFidSet = (RooDataSet*)mcpnWFidSet->reduce(Cut(cutsFid)); 
  RooDataSet* mcpnWFidSetPlus = (RooDataSet*)mcpnWFidSet->reduce("chargeGen==+1.0");
  RooDataSet* mcpnWFidSetMinus = (RooDataSet*)mcpnWFidSet->reduce("chargeGen==-1.0");

  // nn
  RooDataSet* mcnnWFidSet = fillHIMuonGenSet("/usatlas/u/tbales/scratch/",fileNameIn_nn+".root",muonGenArgSet); 
  mcnnWFidSet = (RooDataSet*)mcnnWFidSet->reduce(Cut(cutsFid)); 
  RooDataSet* mcnnWFidSetPlus = (RooDataSet*)mcnnWFidSet->reduce("chargeGen==+1.0");
  RooDataSet* mcnnWFidSetMinus = (RooDataSet*)mcnnWFidSet->reduce("chargeGen==-1.0");
  ...
  // pp
  RooDataSet* mcppSetWRecHiQualityWsel =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/",fileNameIn_pp+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  mcppSetWRecHiQualityWsel =
        (RooDataSet*)mcppSetWRecHiQualityWsel->reduce(Cut(cutsRecHiQualityWsel)); 
  mcppSetWRecHiQualityWsel = (RooDataSet*)mcppSetWRecHiQualityWsel->reduce(Cut("motherRec==24"));
  // mu+
  RooDataSet* mcppSetWRecHiQualityWselPlus = (RooDataSet*)mcppSetWRecHiQualityWsel->reduce(Cut("muonCharge==+1.0"));
  // mu-
  RooDataSet* mcppSetWRecHiQualityWselMinus = (RooDataSet*)mcppSetWRecHiQualityWsel->reduce(Cut("muonCharge==-1.0"));

  // np
  RooDataSet* mcnpSetWRecHiQualityWsel =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/",fileNameIn_np+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  mcnpSetWRecHiQualityWsel =
        (RooDataSet*)mcnpSetWRecHiQualityWsel->reduce(Cut(cutsRecHiQualityWsel)); 
  mcnpSetWRecHiQualityWsel = (RooDataSet*)mcnpSetWRecHiQualityWsel->reduce(Cut("motherRec==24"));
  // mu+
  RooDataSet* mcnpSetWRecHiQualityWselPlus = (RooDataSet*)mcnpSetWRecHiQualityWsel->reduce(Cut("muonCharge==+1.0"));
  // mu-
  RooDataSet* mcnpSetWRecHiQualityWselMinus = (RooDataSet*)mcnpSetWRecHiQualityWsel->reduce(Cut("muonCharge==-1.0"));

  // pn
  RooDataSet* mcpnSetWRecHiQualityWsel =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/",fileNameIn_pn+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  mcpnSetWRecHiQualityWsel =
        (RooDataSet*)mcpnSetWRecHiQualityWsel->reduce(Cut(cutsRecHiQualityWsel)); 
  mcpnSetWRecHiQualityWsel = (RooDataSet*)mcpnSetWRecHiQualityWsel->reduce(Cut("motherRec==24"));
  // mu+
  RooDataSet* mcpnSetWRecHiQualityWselPlus = (RooDataSet*)mcpnSetWRecHiQualityWsel->reduce(Cut("muonCharge==+1.0"));
  // mu-
  RooDataSet* mcpnSetWRecHiQualityWselMinus = (RooDataSet*)mcpnSetWRecHiQualityWsel->reduce(Cut("muonCharge==-1.0"));

  // nn
  RooDataSet* mcnnSetWRecHiQualityWsel =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/",fileNameIn_nn+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  mcnnSetWRecHiQualityWsel =
        (RooDataSet*)mcnnSetWRecHiQualityWsel->reduce(Cut(cutsRecHiQualityWsel)); 
  mcnnSetWRecHiQualityWsel = (RooDataSet*)mcnnSetWRecHiQualityWsel->reduce(Cut("motherRec==24"));
  // mu+
  RooDataSet* mcnnSetWRecHiQualityWselPlus = (RooDataSet*)mcnnSetWRecHiQualityWsel->reduce(Cut("muonCharge==+1.0"));
  // mu-
  RooDataSet* mcnnSetWRecHiQualityWselMinus = (RooDataSet*)mcnnSetWRecHiQualityWsel->reduce(Cut("muonCharge==-1.0"));
  ...
  for ( int i = 0; i < nPtBins; i++ ) {
	...
	_cWResiduals.Add( new TGraph(nCentralityBins) );
      ...
      for ( int k = 0; k < nCentralityBins; k++ ){
        ...
        if(doEta){
	    // pp
            mcppWGenSubSetPlus[i][j][k] = selectPtEtaCentrality(mcppWGenSetPlus ,ptBins[i],ptBins[i+1], etaBins[j],
                etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
            mcppWGenSubSetMinus[i][j][k] = selectPtEtaCentrality(mcppWGenSetMinus ,ptBins[i],ptBins[i+1], etaBins[j],
                etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 

	    // np
            mcnpWGenSubSetPlus[i][j][k] = selectPtEtaCentrality(mcnpWGenSetPlus ,ptBins[i],ptBins[i+1], etaBins[j],
                etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
            mcnpWGenSubSetMinus[i][j][k] = selectPtEtaCentrality(mcnpWGenSetMinus ,ptBins[i],ptBins[i+1], etaBins[j],
                etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 

	    // pn
            mcpnWGenSubSetPlus[i][j][k] = selectPtEtaCentrality(mcpnWGenSetPlus ,ptBins[i],ptBins[i+1], etaBins[j],
                etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
            mcpnWGenSubSetMinus[i][j][k] = selectPtEtaCentrality(mcpnWGenSetMinus ,ptBins[i],ptBins[i+1], etaBins[j],
                etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 

	    // nn
            mcnnWGenSubSetPlus[i][j][k] = selectPtEtaCentrality(mcnnWGenSetPlus ,ptBins[i],ptBins[i+1], etaBins[j],
                etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
            mcnnWGenSubSetMinus[i][j][k] = selectPtEtaCentrality(mcnnWGenSetMinus ,ptBins[i],ptBins[i+1], etaBins[j],
                etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
        }
        else{
        ...
        // pp
        // mu+
        mcppWFidSubSetPlus[i][j][k] = selectPtEtaCentrality(mcppWFidSetPlus ,ptBins[i],ptBins[i+1], etaBins[j],
            etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
        std::cout << " " << i << ":" << j << ":" << k << " = " << mcppWFidSubSetPlus[i][j][k]->numEntries()<< std::endl;
	// mu-
        mcppWFidSubSetMinus[i][j][k] = selectPtEtaCentrality(mcppWFidSetMinus ,ptBins[i],ptBins[i+1], etaBins[j],
            etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
        std::cout << " " << i << ":" << j << ":" << k << " = " << mcppWFidSubSetMinus[i][j][k]->numEntries()<< std::endl;

        // np
        // mu+
        mcnpWFidSubSetPlus[i][j][k] = selectPtEtaCentrality(mcnpWFidSetPlus ,ptBins[i],ptBins[i+1], etaBins[j],
            etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
        std::cout << " " << i << ":" << j << ":" << k << " = " << mcnpWFidSubSetPlus[i][j][k]->numEntries()<< std::endl;
	// mu-
        mcnpWFidSubSetMinus[i][j][k] = selectPtEtaCentrality(mcnpWFidSetMinus ,ptBins[i],ptBins[i+1], etaBins[j],
            etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
        std::cout << " " << i << ":" << j << ":" << k << " = " << mcnpWFidSubSetMinus[i][j][k]->numEntries()<< std::endl;

        // pn
        // mu+
        mcpnWFidSubSetPlus[i][j][k] = selectPtEtaCentrality(mcpnWFidSetPlus ,ptBins[i],ptBins[i+1], etaBins[j],
            etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
        std::cout << " " << i << ":" << j << ":" << k << " = " << mcpnWFidSubSetPlus[i][j][k]->numEntries()<< std::endl;
	// mu-
        mcpnWFidSubSetMinus[i][j][k] = selectPtEtaCentrality(mcpnWFidSetMinus ,ptBins[i],ptBins[i+1], etaBins[j],
            etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
        std::cout << " " << i << ":" << j << ":" << k << " = " << mcpnWFidSubSetMinus[i][j][k]->numEntries()<< std::endl;

        // nn
        // mu+
        mcnnWFidSubSetPlus[i][j][k] = selectPtEtaCentrality(mcnnWFidSetPlus ,ptBins[i],ptBins[i+1], etaBins[j],
            etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
        std::cout << " " << i << ":" << j << ":" << k << " = " << mcnnWFidSubSetPlus[i][j][k]->numEntries()<< std::endl;
	// mu-
        mcnnWFidSubSetMinus[i][j][k] = selectPtEtaCentrality(mcnnWFidSetMinus ,ptBins[i],ptBins[i+1], etaBins[j],
            etaBins[j+1],centBins[k], centBins[k+1],doMirrorEta,true); 
