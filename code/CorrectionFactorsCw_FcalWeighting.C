...
double getWeight(const TH1F* h, double fcal){

    TF1* f = h->GetFunction("f1");
    double weight = f->Eval(fcal);
...
// fillHIMuonRecSet
///////////////////////////////////////////////////////////////////////////////
void fillHIMuonRecSet(RooDataSet* set,const TString& pathName, const TString& fileName, RooArgSet& muonArgSet, const TH1F* h,bool doMptSigmaUp = false, bool doMptSigmaDown=false)
{
  ...
  */
  ...
  for ( int i = 0; i < tree->GetEntries(); i++ ) {
    ...
    for (int imu = 0; imu<nmu;imu++){
      ...
      double w = getWeight(h,fcalNt);
      set->add(muonArgSet,w);    
   }
  }
...
void fillHIMuonGenSet(RooDataSet* set, const TString& pathName, const TString& fileName, RooArgSet& muonGenSet,const TH1F* h)
{
...
void CorrectionFactorsCw_FcalWeighting(){
...
TString fileWithWeights = "crossChecks/fcalWeights";
TFile* _fWeights = new TFile(fileWithWeights+".root","read");
//histo with weights
TH1F* hWts = (TH1F*)_fWeights->Get("weights");
...
//  TString sCutsRec = "muonQuality>11&&abs(muonELoss)<0.5&&abs(muonScat)<4.0&&abs(muonEta)<2.4&&muonPt>33.5&&missPt>25.0&&isolation<0.1&&muonMt>40.0&&ZDY==0";
  ...
  RooDataSet* mcppWGenSetPlus = new RooDataSet(fileNameIn_ppPlus+".root",fileNameIn_ppPlus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcppWGenSetPlus,"/usatlas/u/tbales/scratch/",fileNameIn_ppPlus+".root",muonGenArgSet,hWts); mcppWGenSetPlus->Print();
  ...
  RooDataSet* mcppWGenSetMinus = new RooDataSet(fileNameIn_ppMinus+".root",fileNameIn_ppMinus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcppWGenSetMinus,"/usatlas/u/tbales/scratch/",fileNameIn_ppMinus+".root",muonGenArgSet,hWts); mcppWGenSetMinus->Print();
  double nWminu_pp = mcppWGenSetMinus->sumEntries();
  RooDataSet* mcnpWGenSetPlus = new RooDataSet(fileNameIn_npPlus+".root",fileNameIn_npPlus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcnpWGenSetPlus,"/usatlas/u/tbales/scratch/",fileNameIn_npPlus+".root",muonGenArgSet,hWts); mcnpWGenSetPlus->Print();
  double nWplus_np = mcnpWGenSetPlus->sumEntries();
  RooDataSet* mcnpWGenSetMinus = new RooDataSet(fileNameIn_npMinus+".root",fileNameIn_npMinus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcnpWGenSetMinus,"/usatlas/u/tbales/scratch/",fileNameIn_npMinus+".root",muonGenArgSet,hWts); mcnpWGenSetMinus->Print();
  double nWminu_np = mcnpWGenSetMinus->sumEntries();
  RooDataSet* mcpnWGenSetPlus = new RooDataSet(fileNameIn_pnPlus+".root",fileNameIn_pnPlus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcpnWGenSetPlus,"/usatlas/u/tbales/scratch/",fileNameIn_pnPlus+".root",muonGenArgSet,hWts); mcpnWGenSetPlus->Print();
  double nWplus_pn = mcpnWGenSetPlus->sumEntries();
  RooDataSet* mcpnWGenSetMinus = new RooDataSet(fileNameIn_pnMinus+".root",fileNameIn_pnMinus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcpnWGenSetMinus,"/usatlas/u/tbales/scratch/",fileNameIn_pnMinus+".root",muonGenArgSet,hWts); mcpnWGenSetMinus->Print();
  double nWminu_pn = mcpnWGenSetMinus->sumEntries();
  RooDataSet* mcnnWGenSetPlus = new RooDataSet(fileNameIn_nnPlus+".root",fileNameIn_nnPlus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcnnWGenSetPlus,"/usatlas/u/tbales/scratch/",fileNameIn_nnPlus+".root",muonGenArgSet,hWts); mcnnWGenSetPlus->Print();
  double nWplus_nn = mcnnWGenSetPlus->sumEntries();
  RooDataSet* mcnnWGenSetMinus = new RooDataSet(fileNameIn_nnMinus+".root",fileNameIn_nnMinus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcnnWGenSetMinus,"/usatlas/u/tbales/scratch/",fileNameIn_nnMinus+".root",muonGenArgSet,hWts); mcnnWGenSetMinus->Print();
  ...
  RooDataSet* mcppWFidSetPlus = new RooDataSet(fileNameIn_ppPlus+".root",fileNameIn_ppPlus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcppWFidSetPlus,"/usatlas/u/tbales/scratch/",fileNameIn_ppPlus+".root",muonGenArgSet,hWts); 
  mcppWFidSetPlus = (RooDataSet*)mcppWFidSetPlus->reduce(Cut(cutsFid)); 
  RooDataSet* mcppWFidSetMinus = new RooDataSet(fileNameIn_ppMinus+".root",fileNameIn_ppMinus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcppWFidSetMinus,"/usatlas/u/tbales/scratch/",fileNameIn_ppMinus+".root",muonGenArgSet,hWts); 
  mcppWFidSetMinus = (RooDataSet*)mcppWFidSetMinus->reduce(Cut(cutsFid)); 

  RooDataSet* mcnpWFidSetPlus = new RooDataSet(fileNameIn_npPlus+".root",fileNameIn_npPlus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcnpWFidSetPlus,"/usatlas/u/tbales/scratch/",fileNameIn_npPlus+".root",muonGenArgSet,hWts); 
  mcnpWFidSetPlus = (RooDataSet*)mcnpWFidSetPlus->reduce(Cut(cutsFid)); 
  RooDataSet* mcnpWFidSetMinus = new RooDataSet(fileNameIn_npMinus+".root",fileNameIn_npMinus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcnpWFidSetMinus,"/usatlas/u/tbales/scratch/",fileNameIn_npMinus+".root",muonGenArgSet,hWts); 
  mcnpWFidSetMinus = (RooDataSet*)mcnpWFidSetMinus->reduce(Cut(cutsFid)); 

  RooDataSet* mcpnWFidSetPlus = new RooDataSet(fileNameIn_pnPlus+".root",fileNameIn_pnPlus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcpnWFidSetPlus,"/usatlas/u/tbales/scratch/",fileNameIn_pnPlus+".root",muonGenArgSet,hWts); 
  mcpnWFidSetPlus = (RooDataSet*)mcpnWFidSetPlus->reduce(Cut(cutsFid)); 
  RooDataSet* mcpnWFidSetMinus = new RooDataSet(fileNameIn_pnMinus+".root",fileNameIn_pnMinus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcpnWFidSetMinus,"/usatlas/u/tbales/scratch/",fileNameIn_pnMinus+".root",muonGenArgSet,hWts); 
  mcpnWFidSetMinus = (RooDataSet*)mcpnWFidSetMinus->reduce(Cut(cutsFid)); 

  RooDataSet* mcnnWFidSetPlus = new RooDataSet(fileNameIn_nnPlus+".root",fileNameIn_nnPlus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcnnWFidSetPlus,"/usatlas/u/tbales/scratch/",fileNameIn_nnPlus+".root",muonGenArgSet,hWts); 
  mcnnWFidSetPlus = (RooDataSet*)mcnnWFidSetPlus->reduce(Cut(cutsFid)); 
  RooDataSet* mcnnWFidSetMinus = new RooDataSet(fileNameIn_nnMinus+".root",fileNameIn_nnMinus+".root",muonGenArgSet,"weight");
  fillHIMuonGenSet(mcnnWFidSetMinus,"/usatlas/u/tbales/scratch/",fileNameIn_nnMinus+".root",muonGenArgSet,hWts); 
...
/////////////////////
  ...
  // pp
  // mu+
  RooDataSet* mcppSetWRecHiQualityWselPlus = new RooDataSet(fileNameIn_ppPlus+".root",fileNameIn_ppPlus+".root",muonRecArgSet,"weight");
        fillHIMuonRecSet(mcppSetWRecHiQualityWselPlus,"/usatlas/u/tbales/scratch/",fileNameIn_ppPlus+".root",muonRecArgSet,hWts,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcppSetWRecHiQualityWselMinus = new RooDataSet(fileNameIn_ppMinus+".root",fileNameIn_ppMinus+".root",muonRecArgSet,"weight");
        fillHIMuonRecSet(mcppSetWRecHiQualityWselMinus,"/usatlas/u/tbales/scratch/",fileNameIn_ppMinus+".root",muonRecArgSet,hWts,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcnpSetWRecHiQualityWselPlus = new RooDataSet(fileNameIn_npPlus+".root",fileNameIn_npPlus+".root",muonRecArgSet,"weight");
        fillHIMuonRecSet(mcnpSetWRecHiQualityWselPlus,"/usatlas/u/tbales/scratch/",fileNameIn_npPlus+".root",muonRecArgSet,hWts,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcnpSetWRecHiQualityWselMinus = new RooDataSet(fileNameIn_npMinus+".root",fileNameIn_npMinus+".root",muonRecArgSet,"weight");
        fillHIMuonRecSet(mcnpSetWRecHiQualityWselMinus,"/usatlas/u/tbales/scratch/",fileNameIn_npMinus+".root",muonRecArgSet,hWts,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcpnSetWRecHiQualityWselPlus = new RooDataSet(fileNameIn_pnPlus+".root",fileNameIn_pnPlus+".root",muonRecArgSet,"weight");
        fillHIMuonRecSet(mcpnSetWRecHiQualityWselPlus,"/usatlas/u/tbales/scratch/",fileNameIn_pnPlus+".root",muonRecArgSet,hWts,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcpnSetWRecHiQualityWselMinus = new RooDataSet(fileNameIn_pnMinus+".root",fileNameIn_pnMinus+".root",muonRecArgSet,"weight");
        fillHIMuonRecSet(mcpnSetWRecHiQualityWselMinus,"/usatlas/u/tbales/scratch/",fileNameIn_pnMinus+".root",muonRecArgSet,hWts,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcnnSetWRecHiQualityWselPlus = new RooDataSet(fileNameIn_nnPlus+".root",fileNameIn_nnPlus+".root",muonRecArgSet,"weight");
        fillHIMuonRecSet(mcnnSetWRecHiQualityWselPlus,"/usatlas/u/tbales/scratch/",fileNameIn_nnPlus+".root",muonRecArgSet,hWts,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcnnSetWRecHiQualityWselMinus = new RooDataSet(fileNameIn_nnMinus+".root",fileNameIn_nnMinus+".root",muonRecArgSet,"weight");
        fillHIMuonRecSet(mcnnSetWRecHiQualityWselMinus,"/usatlas/u/tbales/scratch/",fileNameIn_nnMinus+".root",muonRecArgSet,hWts,doMptSigmaUp,doMptSigmaDown); 
...
/////////////////////
  ...
  Efficiency((double)mcppSetWRecHiQualityWselPlus->sumEntries(),(double)mcppWFidSetPlus->sumEntries(),0.683,pp_cwPlus,pp_errCwPlusLo,pp_errCwPlusHi);
  std::cout << " pp: Cw+[average] = " << pp_cwPlus << " +/- " << pp_errCwPlusHi-pp_cwPlus << std::endl;
  double pp_cwMinus,pp_errCwMinusLo,pp_errCwMinusHi;
  Efficiency((double)mcppSetWRecHiQualityWselMinus->sumEntries(),(double)mcppWFidSetMinus->sumEntries(),0.683,pp_cwMinus,pp_errCwMinusLo,pp_errCwMinusHi);
  std::cout << " pp: Cw-[average] = " << pp_cwMinus << " +/- " << pp_errCwMinusHi-pp_cwMinus << std::endl;

  // np

  double np_cwPlus,np_errCwPlusLo,np_errCwPlusHi;
  Efficiency((double)mcnpSetWRecHiQualityWselPlus->sumEntries(),(double)mcnpWFidSetPlus->sumEntries(),0.683,np_cwPlus,np_errCwPlusLo,np_errCwPlusHi);
  std::cout << " np: Cw+[average] = " << np_cwPlus << " +/- " << np_errCwPlusHi-np_cwPlus << std::endl;
  double np_cwMinus,np_errCwMinusLo,np_errCwMinusHi;
  Efficiency((double)mcnpSetWRecHiQualityWselMinus->sumEntries(),(double)mcnpWFidSetMinus->sumEntries(),0.683,np_cwMinus,np_errCwMinusLo,np_errCwMinusHi);
  std::cout << " np: Cw-[average] = " << np_cwMinus << " +/- " << np_errCwMinusHi-np_cwMinus << std::endl;
  // pn

  double pn_cwPlus,pn_errCwPlusLo,pn_errCwPlusHi;
  Efficiency((double)mcpnSetWRecHiQualityWselPlus->sumEntries(),(double)mcpnWFidSetPlus->sumEntries(),0.683,pn_cwPlus,pn_errCwPlusLo,pn_errCwPlusHi);
  std::cout << " pn: Cw+[average] = " << pn_cwPlus << " +/- " << pn_errCwPlusHi-pn_cwPlus << std::endl;
  double pn_cwMinus,pn_errCwMinusLo,pn_errCwMinusHi;
  Efficiency((double)mcpnSetWRecHiQualityWselMinus->sumEntries(),(double)mcpnWFidSetMinus->sumEntries(),0.683,pn_cwMinus,pn_errCwMinusLo,pn_errCwMinusHi);
  std::cout << " pn: Cw-[average] = " << pn_cwMinus << " +/- " << pn_errCwMinusHi-pn_cwMinus << std::endl;
  // nn

  double nn_cwPlus,nn_errCwPlusLo,nn_errCwPlusHi;
  Efficiency((double)mcnnSetWRecHiQualityWselPlus->sumEntries(),(double)mcnnWFidSetPlus->sumEntries(),0.683,nn_cwPlus,nn_errCwPlusLo,nn_errCwPlusHi);
  std::cout << " nn: Cw+[average] = " << nn_cwPlus << " +/- " << nn_errCwPlusHi-nn_cwPlus << std::endl;
  double nn_cwMinus,nn_errCwMinusLo,nn_errCwMinusHi;
  Efficiency((double)mcnnSetWRecHiQualityWselMinus->sumEntries(),(double)mcnnWFidSetMinus->sumEntries(),0.683,nn_cwMinus,nn_errCwMinusLo,nn_errCwMinusHi);
  ...
  for ( int i = 0; i < nPtBins; i++ ) {
	...
	_cWResiduals.Add( new TGraph(nCentralityBins) );
      ...
      for ( int k = 0; k < nCentralityBins; k++ ){
	    ...
	    // pp
            ...
            std::cout << "is Weighted? : " << mcppWGenSubSetPlus[i][j][k]->isWeighted() << ", " << mcppWGenSubSetPlus[i][j][k]->weight() << std::endl;
        ...
        std::cout << "is Weighted? : " << mcppWFidSubSetPlus[i][j][k]->isWeighted() << ", " << mcppWFidSubSetPlus[i][j][k]->weight() << std::endl;
	// mu-
	...
	// mu-
        ...
        std::cout << "is Weighted? : " << mcppSubSetWRecHiQualityWselPlus[i][j][k]->isWeighted() << ", " << mcppSubSetWRecHiQualityWselPlus[i][j][k]->weight() << std::endl;
        // mu-
...
int main(){
    CorrectionFactorsCw_FcalWeighting();
