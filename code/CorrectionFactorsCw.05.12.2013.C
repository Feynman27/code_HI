...
//    std::cout << "ptRecOnly = " << ptRecOnly << std::endl;
    ...
    std::cout << "Cw before trigger correction for bin = " << ieta << ":" << icent << " = "  << recoEff5 << std::endl;
    recoEff5*=trigTemp;
    std::cout << "Cw after trigger correction for bin = " << ieta << ":" << icent << " = "  << recoEff5 << std::endl;
...
void calcEffCent(RooDataSet* mcWGenSet, RooDataSet* mcWFidSet,RooDataSet* mcWRecSet0, RooDataSet* mcWRecSet1,
                ...
                TGraphErrors* const grWRecEff0, TGraphErrors* const grWRecEff1,TGraphErrors* const grWRecEff2,
                TGraphErrors* const grWRecEff3,TGraphErrors* const grWRecEff4,TGraphErrors* const grWRecEff5, 
                TGraphErrors* const grToScale,bool doScale = false, std::ostream& output ){
    ...
    writeToSpreadsheet(output,ieta,icent,recoEff5,recoStatErr5);
    if(doScale){
...
// --- declare cut variables at reco level --- //
  ...
  TString sCutsFid = "muonGenPt>25.0&&abs(etaGen)<2.4&&nuGenPt>25.0&&munuGenMt>40.0&&abs(mother)==24&&abs(daughter)==13";
    ...
    ///pt check
//  TString sCutsFid = "muonGenPt>40.0&&abs(etaGen)<2.4&&nuGenPt>25.0&&munuGenMt>40.0&&abs(mother)==24&&abs(daughter)==13";
...
*/
            ...
            calcEffCent(mcWGenSubSet[ipt][ieta][icent],mcWFidSubSet[ipt][ieta][icent],
                    ...
                    mcSubSetWRecHiQualityWsel[ipt][ieta][icent],
                    104,ipt,ieta, icent, index, nCentralityBins,nEtaBins,npart, xEta,
                    grWRecEff0Cent,grWRecEff1Cent,grWRecEff2Cent,grWRecEff3Cent,grWRecEff4Cent,grWRecEff5Cent,grToScale,doScale,spreadSheet);
			...
			if(doCharge) {
			  ...
			  if(doPlotPt){
				...
				std::cout << "mu^{+}" << std::endl;
                calcEffCent(mcWGenSetPlus,mcWFidSetPlus,
                        ...
                        grWRecEff0CentPlus,grWRecEff1CentPlus,grWRecEff2CentPlus,grWRecEff3CentPlus,grWRecEff4CentPlus,grWRecEff5CentPlus,grToScale,doScale,spreadSheetPlus);



				std::cout << "mu^{-}" << std::endl;
                calcEffCent(mcWGenSetMinus,mcWFidSetMinus,
                        ...
                        grWRecEff0CentMinus,grWRecEff1CentMinus,grWRecEff2CentMinus,grWRecEff3CentMinus,grWRecEff4CentMinus,grWRecEff5CentMinus,grToScale,doScale,spreadSheetMinus);
