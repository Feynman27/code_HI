...
void calcEfficiency(RooDataSet* mcWGenSet, RooDataSet* mcWFidSet,RooDataSet* mcWRecSet,
    ...
    ///RecHiQualityWsel
    int pRec = (int)mcWRecSet->numEntries() ;
...
// --- declare variables at generator level --- //
  ...
  RooRealVar  muBarcodeGen("muBarcodeGen","muBarcodeGen",-1e6,1e6);
...
//  TString sCutsRec = "muonQuality>11&&abs(muonELoss)<0.5&&abs(muonScat)<4.0&&abs(muonEta)<2.4&&muonPt>33.5&&missPt>25.0&&isolation<0.1&&muonMt>40.0&&ZDY==0";
  ...
  RooDataSet* mcppWGenSetPlus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_ppPlus+".root",muonGenArgSet); mcppWGenSetPlus->Print();
  double nWplus_pp = mcppWGenSetPlus->numEntries();
  //double nWplus_pp2 = mcppWGenSetPlus->sumEntries();
  //std::cout << nWplus_pp<<"=?"<<nWplus_pp2<<std::endl;exit(0); 
  RooDataSet* mcppWGenSetMinus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_ppMinus+".root",muonGenArgSet); mcppWGenSetMinus->Print();
  double nWminu_pp = mcppWGenSetMinus->numEntries();
  RooDataSet* mcnpWGenSetPlus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_npPlus+".root",muonGenArgSet); mcnpWGenSetPlus->Print();
  double nWplus_np = mcnpWGenSetPlus->numEntries();
  RooDataSet* mcnpWGenSetMinus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_npMinus+".root",muonGenArgSet); mcnpWGenSetMinus->Print();
  double nWminu_np = mcnpWGenSetMinus->numEntries();
  RooDataSet* mcpnWGenSetPlus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_pnPlus+".root",muonGenArgSet); mcpnWGenSetPlus->Print();
  double nWplus_pn = mcpnWGenSetPlus->numEntries();
  RooDataSet* mcpnWGenSetMinus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_pnMinus+".root",muonGenArgSet); mcpnWGenSetMinus->Print();
  double nWminu_pn = mcpnWGenSetMinus->numEntries();
  RooDataSet* mcnnWGenSetPlus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_nnPlus+".root",muonGenArgSet); mcnnWGenSetPlus->Print();
  double nWplus_nn = mcnnWGenSetPlus->numEntries();
  RooDataSet* mcnnWGenSetMinus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_nnMinus+".root",muonGenArgSet); mcnnWGenSetMinus->Print();
  double nWminu_nn = mcnnWGenSetMinus->numEntries();
  ...
  RooDataSet* mcppWFidSetPlus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_ppPlus+".root",muonGenArgSet); 
  mcppWFidSetPlus = (RooDataSet*)mcppWFidSetPlus->reduce(Cut(cutsFid)); 
  RooDataSet* mcppWFidSetMinus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_ppMinus+".root",muonGenArgSet); 
  mcppWFidSetMinus = (RooDataSet*)mcppWFidSetMinus->reduce(Cut(cutsFid)); 

  RooDataSet* mcnpWFidSetPlus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_npPlus+".root",muonGenArgSet); 
  mcnpWFidSetPlus = (RooDataSet*)mcnpWFidSetPlus->reduce(Cut(cutsFid)); 
  RooDataSet* mcnpWFidSetMinus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_npMinus+".root",muonGenArgSet); 
  mcnpWFidSetMinus = (RooDataSet*)mcnpWFidSetMinus->reduce(Cut(cutsFid)); 

  RooDataSet* mcpnWFidSetPlus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_pnPlus+".root",muonGenArgSet); 
  mcpnWFidSetPlus = (RooDataSet*)mcpnWFidSetPlus->reduce(Cut(cutsFid)); 
  RooDataSet* mcpnWFidSetMinus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_pnMinus+".root",muonGenArgSet); 
  mcpnWFidSetMinus = (RooDataSet*)mcpnWFidSetMinus->reduce(Cut(cutsFid)); 

  RooDataSet* mcnnWFidSetPlus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_nnPlus+".root",muonGenArgSet); 
  mcnnWFidSetPlus = (RooDataSet*)mcnnWFidSetPlus->reduce(Cut(cutsFid)); 
  RooDataSet* mcnnWFidSetMinus = fillHIMuonGenSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_nnMinus+".root",muonGenArgSet); 
  ...
  double pp_fidPlus = mcppWFidSetPlus->numEntries(); double pp_genPlus = mcppWGenSetPlus->numEntries();
  Efficiency(pp_fidPlus,pp_genPlus,0.683,pp_awPlus,pp_errAwPlusLo,pp_errAwPlusHi);
  std::cout << " Aw+ = " << mcppWFidSetPlus->numEntries() << "/" << mcppWGenSetPlus->numEntries() << " = " << pp_fidPlus/pp_genPlus << std::endl;
  std::cout << "Consistency check: " << pp_fidPlus/pp_genPlus << " =? " << pp_awPlus << std::endl;
  // Aw-
  double pp_awMinus,pp_errAwMinusLo,pp_errAwMinusHi;
  double pp_fidMinus = mcppWFidSetMinus->numEntries(); double pp_genMinus = mcppWGenSetMinus->numEntries();
  Efficiency(pp_fidMinus,pp_genMinus,0.683,pp_awMinus,pp_errAwMinusLo,pp_errAwMinusHi);
  std::cout << " Aw- = " << mcppWFidSetMinus->numEntries() << "/" << mcppWGenSetMinus->numEntries() << " = " << pp_fidMinus/pp_genMinus << std::endl;
  std::cout << "Consistency check: " << pp_fidMinus/pp_genMinus << " =? " << pp_awMinus << std::endl;
  // np
  // Aw+
  double np_awPlus,np_errAwPlusLo,np_errAwPlusHi;
  double np_fidPlus = mcnpWFidSetPlus->numEntries(); double np_genPlus = mcnpWGenSetPlus->numEntries();
  Efficiency(np_fidPlus,np_genPlus,0.683,np_awPlus,np_errAwPlusLo,np_errAwPlusHi);
  std::cout << " Aw+ = " << mcnpWFidSetPlus->numEntries() << "/" << mcnpWGenSetPlus->numEntries() << " = " << np_fidPlus/np_genPlus << std::endl;
  std::cout << "Consistency check: " << np_fidPlus/np_genPlus << " =? " << np_awPlus << std::endl;
  // Aw-
  double np_awMinus,np_errAwMinusLo,np_errAwMinusHi;
  double np_fidMinus = mcnpWFidSetMinus->numEntries(); double np_genMinus = mcnpWGenSetMinus->numEntries();
  Efficiency(np_fidMinus,np_genMinus,0.683,np_awMinus,np_errAwMinusLo,np_errAwMinusHi);
  std::cout << " Aw- = " << mcnpWFidSetMinus->numEntries() << "/" << mcnpWGenSetMinus->numEntries() << " = " << np_fidMinus/np_genMinus << std::endl;
  std::cout << "Consistency check: " << np_fidMinus/np_genMinus << " =? " << np_awMinus << std::endl;
  // pn
  // Aw+
  double pn_awPlus,pn_errAwPlusLo,pn_errAwPlusHi;
  double pn_fidPlus = mcpnWFidSetPlus->numEntries(); double pn_genPlus = mcpnWGenSetPlus->numEntries();
  Efficiency(pn_fidPlus,pn_genPlus,0.683,pn_awPlus,pn_errAwPlusLo,pn_errAwPlusHi);
  std::cout << " Aw+ = " << mcpnWFidSetPlus->numEntries() << "/" << mcpnWGenSetPlus->numEntries() << " = " << pn_fidPlus/pn_genPlus << std::endl;
  std::cout << "Consistency check: " << pn_fidPlus/pn_genPlus << " =? " << pn_awPlus << std::endl;
  // Aw-
  double pn_awMinus,pn_errAwMinusLo,pn_errAwMinusHi;
  double pn_fidMinus = mcpnWFidSetMinus->numEntries(); double pn_genMinus = mcpnWGenSetMinus->numEntries();
  Efficiency(pn_fidMinus,pn_genMinus,0.683,pn_awMinus,pn_errAwMinusLo,pn_errAwMinusHi);
  std::cout << " Aw- = " << mcpnWFidSetMinus->numEntries() << "/" << mcpnWGenSetMinus->numEntries() << " = " << pn_fidMinus/pn_genMinus << std::endl;
  std::cout << "Consistency check: " << pn_fidMinus/pn_genMinus << " =? " << pn_awMinus << std::endl;
  // nn
  // Aw+
  double nn_awPlus,nn_errAwPlusLo,nn_errAwPlusHi;
  double nn_fidPlus = mcnnWFidSetPlus->numEntries(); double nn_genPlus = mcnnWGenSetPlus->numEntries();
  Efficiency(nn_fidPlus,nn_genPlus,0.683,nn_awPlus,nn_errAwPlusLo,nn_errAwPlusHi);
  std::cout << " Aw+ = " << mcnnWFidSetPlus->numEntries() << "/" << mcnnWGenSetPlus->numEntries() << " = " << nn_fidPlus/nn_genPlus << std::endl;
  std::cout << "Consistency check: " << nn_fidPlus/nn_genPlus << " =? " << nn_awPlus << std::endl;
  // Aw-
  double nn_awMinus,nn_errAwMinusLo,nn_errAwMinusHi;
  double nn_fidMinus = mcnnWFidSetMinus->numEntries(); double nn_genMinus = mcnnWGenSetMinus->numEntries();
  Efficiency(nn_fidMinus,nn_genMinus,0.683,nn_awMinus,nn_errAwMinusLo,nn_errAwMinusHi);
  std::cout << " Aw- = " << mcnnWFidSetMinus->numEntries() << "/" << mcnnWGenSetMinus->numEntries() << " = " << nn_fidMinus/nn_genMinus << std::endl;
  ...
  if(doPlotEta){
    ...
    // combined n+p,p+n 
    TH1F* hnppnGenPlus,*hnppnFidPlus;
    TH1F* hnppnGenMinus,*hnppnFidMinus;

    hnppnGenPlus->Add(hpnGenPlus,hnpGenPlus);
    hnppnGenMinus->Add(hpnGenMinus,hnpGenMinus);

    hnppnFidPlus->Add(hpnFidPlus,hnpFidPlus);
    hnppnFidMinus->Add(hpnFidMinus,hnpFidMinus);

    // plot nucleon-weighted distributions
    TH1F* hwtdGenPlus,*hwtdFidPlus;
    TH1F* hwtdGenMinus,*hwtdFidMinus;
    
    hwtdFidPlus->Add(hppFidPlus,hnppnFidPlus,0.155,0.478); hwtdFidPlus->Add(hnnFidPlus,0.367);
    hwtdFidMinus->Add(hppFidMinus,hnppnFidMinus,0.155,0.478); hwtdFidMinus->Add(hnnFidMinus,0.367);

    hwtdGenPlus->Add(hppGenPlus,hnppnGenPlus,0.155,0.478); hwtdGenPlus->Add(hnnGenPlus,0.367);
    hwtdGenMinus->Add(hppGenMinus,hnppnGenMinus,0.155,0.478); hwtdGenMinus->Add(hnnGenMinus,0.367);

    plotGeneratorDistros(hppGenPlus,hppFidPlus,102,"W^{+}#rightarrow#mu^{+}#nu");
    plotGeneratorDistros(hppGenMinus,hppFidMinus,103,"W^{-}#rightarrow#mu^{-}#nu");
  ...
  RooDataSet* mcppSetWRecHiQualityWselPlus =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_ppPlus+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcppSetWRecHiQualityWselMinus =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_ppMinus+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  ...
  double pp_cwPlus,pp_errCwPlusLo,pp_errCwPlusHi;
  Efficiency((double)mcppSetWRecHiQualityWselPlus->numEntries(),(double)mcppWFidSetPlus->numEntries(),0.683,pp_cwPlus,pp_errCwPlusLo,pp_errCwPlusHi);
  std::cout << " pp: Cw+[average] = " << pp_cwPlus << " +/- " << pp_errCwPlusHi-pp_cwPlus << std::endl;
  double pp_cwMinus,pp_errCwMinusLo,pp_errCwMinusHi;
  Efficiency((double)mcppSetWRecHiQualityWselMinus->numEntries(),(double)mcppWFidSetMinus->numEntries(),0.683,pp_cwMinus,pp_errCwMinusLo,pp_errCwMinusHi);
  std::cout << " pp: Cw-[average] = " << pp_cwMinus << " +/- " << pp_errCwMinusHi-pp_cwMinus << std::endl;

  // np
  // mu+
  RooDataSet* mcnpSetWRecHiQualityWselPlus =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_npPlus+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcnpSetWRecHiQualityWselMinus =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_npMinus+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  ...
  double np_cwPlus,np_errCwPlusLo,np_errCwPlusHi;
  Efficiency((double)mcnpSetWRecHiQualityWselPlus->numEntries(),(double)mcnpWFidSetPlus->numEntries(),0.683,np_cwPlus,np_errCwPlusLo,np_errCwPlusHi);
  std::cout << " np: Cw+[average] = " << np_cwPlus << " +/- " << np_errCwPlusHi-np_cwPlus << std::endl;
  double np_cwMinus,np_errCwMinusLo,np_errCwMinusHi;
  Efficiency((double)mcnpSetWRecHiQualityWselMinus->numEntries(),(double)mcnpWFidSetMinus->numEntries(),0.683,np_cwMinus,np_errCwMinusLo,np_errCwMinusHi);
  std::cout << " np: Cw-[average] = " << np_cwMinus << " +/- " << np_errCwMinusHi-np_cwMinus << std::endl;
  // pn
  // mu+
  RooDataSet* mcpnSetWRecHiQualityWselPlus =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_pnPlus+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcpnSetWRecHiQualityWselMinus =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_pnMinus+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  ...
  double pn_cwPlus,pn_errCwPlusLo,pn_errCwPlusHi;
  Efficiency((double)mcpnSetWRecHiQualityWselPlus->numEntries(),(double)mcpnWFidSetPlus->numEntries(),0.683,pn_cwPlus,pn_errCwPlusLo,pn_errCwPlusHi);
  std::cout << " pn: Cw+[average] = " << pn_cwPlus << " +/- " << pn_errCwPlusHi-pn_cwPlus << std::endl;
  double pn_cwMinus,pn_errCwMinusLo,pn_errCwMinusHi;
  Efficiency((double)mcpnSetWRecHiQualityWselMinus->numEntries(),(double)mcpnWFidSetMinus->numEntries(),0.683,pn_cwMinus,pn_errCwMinusLo,pn_errCwMinusHi);
  std::cout << " pn: Cw-[average] = " << pn_cwMinus << " +/- " << pn_errCwMinusHi-pn_cwMinus << std::endl;
  // nn
  // mu+
  RooDataSet* mcnnSetWRecHiQualityWselPlus =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_nnPlus+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  ...
  RooDataSet* mcnnSetWRecHiQualityWselMinus =
        fillHIMuonRecSet("/usatlas/u/tbales/scratch/data_files/",fileNameIn_nnMinus+".root",muonRecArgSet,doMptSigmaUp,doMptSigmaDown); 
  ...
  double nn_cwPlus,nn_errCwPlusLo,nn_errCwPlusHi;
  Efficiency((double)mcnnSetWRecHiQualityWselPlus->numEntries(),(double)mcnnWFidSetPlus->numEntries(),0.683,nn_cwPlus,nn_errCwPlusLo,nn_errCwPlusHi);
  std::cout << " nn: Cw+[average] = " << nn_cwPlus << " +/- " << nn_errCwPlusHi-nn_cwPlus << std::endl;
  double nn_cwMinus,nn_errCwMinusLo,nn_errCwMinusHi;
  Efficiency((double)mcnnSetWRecHiQualityWselMinus->numEntries(),(double)mcnnWFidSetMinus->numEntries(),0.683,nn_cwMinus,nn_errCwMinusLo,nn_errCwMinusHi);
  std::cout << " nn: Cw-[average] = " << nn_cwMinus << " +/- " << nn_errCwMinusHi-nn_cwMinus << std::endl;

  std::cout << " Overall Cw+[average] " << 0.155*pp_cwPlus+0.478/2*(pn_cwPlus+np_cwPlus)+0.367*nn_cwPlus << " +/- " <<
    0.155*(pp_errCwPlusHi-pp_cwPlus)+0.478/2*(pn_errCwPlusHi-pn_cwPlus+np_errCwPlusHi-np_cwPlus)+0.367*(nn_errCwPlusHi-nn_cwPlus) << std::endl;
  std::cout << " Overall Cw-[average] " << 0.155*pp_cwMinus+0.478/2*(pn_cwMinus+np_cwMinus)+0.367*(nn_cwMinus) << " +/- " <<
    0.155*(pp_errCwMinusHi-pp_cwMinus)+0.478/2*(pn_errCwMinusHi-pn_cwMinus+np_errCwMinusHi-np_cwMinus)+0.367*(nn_errCwMinusHi-nn_cwMinus) << std::endl;
  // --- Subdivide in bins ---
  // pp
  // mu+
  ...
  for ( int i = 0; i < nPtBins; i++ ) {
	...
	_cWResiduals.Add( new TGraph(nCentralityBins) );
      ...
      for ( int k = 0; k < nCentralityBins; k++ ){
        ...
        std::cout << "Entries in pp subset for mu+: " << i << ":" << j << ":" << k << " = " << mcppWGenSubSetPlus[i][j][k]->numEntries() << std::endl;
        std::cout << "Entries in pp subset for mu-: " << i << ":" << j << ":" << k << " = " << mcppWGenSubSetMinus[i][j][k]->numEntries() << std::endl;

        std::cout << "Entries in np subset for mu+: " << i << ":" << j << ":" << k << " = " << mcnpWGenSubSetPlus[i][j][k]->numEntries() << std::endl;
        std::cout << "Entries in np subset for mu-: " << i << ":" << j << ":" << k << " = " << mcnpWGenSubSetMinus[i][j][k]->numEntries() << std::endl;

        std::cout << "Entries in pn subset for mu+: " << i << ":" << j << ":" << k << " = " << mcpnWGenSubSetPlus[i][j][k]->numEntries() << std::endl;
        std::cout << "Entries in pn subset for mu-: " << i << ":" << j << ":" << k << " = " << mcpnWGenSubSetMinus[i][j][k]->numEntries() << std::endl;

        std::cout << "Entries in nn subset for mu+: " << i << ":" << j << ":" << k << " = " << mcnnWGenSubSetPlus[i][j][k]->numEntries() << std::endl;
        std::cout << "Entries in nn subset for mu-: " << i << ":" << j << ":" << k << " = " << mcnnWGenSubSetMinus[i][j][k]->numEntries() << std::endl;
	...
	// mu-
        ...
        mcnnSubSetWRecHiQualityWselMinus[i][j][k] = selectPtEtaCentrality(mcnnSetWRecHiQualityWselMinus,ptBins[i],ptBins[i+1],
          ...
          if(mcppSubSetWRecHiQualityWselPlus[i][j][k]->numEntries()>mcppWFidSubSetPlus[i][j][k]->numEntries()){
            std::cout << "WARNING: Efficiency > 1.0. " << std::endl; exit(0); 
          }
          if(mcppSubSetWRecHiQualityWselMinus[i][j][k]->numEntries()>mcppWFidSubSetMinus[i][j][k]->numEntries()){
            std::cout << "WARNING: Efficiency > 1.0. " << std::endl; exit(0); 
	  }

          if(mcnpSubSetWRecHiQualityWselPlus[i][j][k]->numEntries()>mcnpWFidSubSetPlus[i][j][k]->numEntries()){
            std::cout << "WARNING: Efficiency > 1.0. " << std::endl; exit(0); 
          }
          if(mcnpSubSetWRecHiQualityWselMinus[i][j][k]->numEntries()>mcnpWFidSubSetMinus[i][j][k]->numEntries()){
            std::cout << "WARNING: Efficiency > 1.0. " << std::endl; exit(0); 
	  }

          if(mcpnSubSetWRecHiQualityWselPlus[i][j][k]->numEntries()>mcpnWFidSubSetPlus[i][j][k]->numEntries()){
            std::cout << "WARNING: Efficiency > 1.0. " << std::endl; exit(0); 
          }
          if(mcpnSubSetWRecHiQualityWselMinus[i][j][k]->numEntries()>mcpnWFidSubSetMinus[i][j][k]->numEntries()){
            std::cout << "WARNING: Efficiency > 1.0. " << std::endl; exit(0); 
	  }

          if(mcnnSubSetWRecHiQualityWselPlus[i][j][k]->numEntries()>mcnnWFidSubSetPlus[i][j][k]->numEntries()){
            std::cout << "WARNING: Efficiency > 1.0. " << std::endl; exit(0); 
          }
          if(mcnnSubSetWRecHiQualityWselMinus[i][j][k]->numEntries()>mcnnWFidSubSetMinus[i][j][k]->numEntries()){
            std::cout << "WARNING: Efficiency > 1.0. " << std::endl; exit(0); 
	  }
    } //k
  } //j
